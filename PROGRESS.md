...
| 6 | Maven publish + BOM + deterministic Monomer bundle | in-progress | 1 | b58954f | immutable `0.2.2`·`0.2.3` published; SQL-plan provenance를 유지하고 scalar-expression gate를 제거한 `0.2.4` parity patch와 Monomer pin 대기 |
